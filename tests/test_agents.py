    ...
    for category in [
        ...
        try:
            ...
            agent = AgentFactory.create_agent(
                category=category, language="en-US", markdown=False
            )
            # Test with Hindi language
            agent = AgentFactory.create_agent(
                category=category, language="hi-IN", markdown=True
            )
...
def test_language_support():
    ...
    for language in languages:
        try:
            agent = AgentFactory.create_agent(
                category=category, language=language, markdown=False
            )
...
def test_unknown_category():
    ...
    try:
        agent = AgentFactory.create_agent(
            category="unknown_category", language="en-US", markdown=False
        )
